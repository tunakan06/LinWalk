...
## Constraints/requirements followed
- Editor-only code guarded by `#if UNITY_EDITOR`.
- Tool does not change scenes unless the user runs the menu command; it edits the open scene and saves after asking confirmation if background exists.
- Includes user dialogs and null checks.
